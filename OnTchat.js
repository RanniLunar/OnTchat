        ...
        <div class='panel-body'>
            ...
            <div id='ontchat-config' class='ontchat-hide'>
                <div id='ontchat-configuration'>
                    ...
                    <!-- <div class="ontchat-config-option" id="ontchat-turbo-delay">
                        <label>
                            <span>Délai Turbo</span>
                        </label>
                        <div class='ontchat-range-option'>
                            <input id="ontchat-turbo-delay-range" type="range" min="0" max="1000" step="50">
                            <span id="ontchat-turbo-delay-span">? ms</span>
                        </div>
                    ...
                    <!-- <div class="ontchat-config-option" id="ontchat-max-width">
                        <label>
                            <span>Largeur des messages</span>
                        </label>
                        <div class='ontchat-range-option'>
                            <input id="ontchat-max-width-range" type="range" min="0" max="100" step="1">
                            <span id="ontchat-max-width-span">? %</span>
                        </div>
...
function toggleTextarea() {
    ...
    document.getElementById("bloc-formulaire-forum").getElementsByClassName("jv-editor-toolbar")[0].classList.toggle("ontchat-hide");
    ...
    document.getElementById("bloc-formulaire-forum").classList.toggle("ontchat-reduced");
...
function clearPage(document) {
    ...
    if (iframe) {
        iframe.parentNode.insertAdjacentElement("beforebegin", iframe);
    }
...
function cleanQuote(text) {
    ...
    for (const child of text.children) {
        ...
        if (child.tagName == "A") {
            ...
            const textNode = document.createTextNode(youtubeURL(child.getElementsByTagName("iframe")[0].src));
            child.replaceWith(textNode);
        }
...
function setSondage(sondage) {
    let choix = document.getElementById("ontchat-sondage-choix");
    ...
    if (!choix.firstChild) {
        document.getElementById("ontchat-sondage-intitule").innerHTML = escape(sondage["intitule"]);
    ...
    document.getElementById("ontchat-sondage-votes").innerHTML = `(${sondage["votes"]} votes)`;
}
...
function insertTextareaAnswer(textToInsert) {
    ...
    <div class="message small">
        ...
        <div class="message-content rmjs-3" style="height: auto; max-height: none;">
